  ...
  return (
    ...
    >
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center">
          ...
          <input
            ...
            className=" placeholder:text-sm placeholder:text-[#2B2B2B] outline-none w-60 p-2  focus:ring-0  focus:border-b-2  "
          />
        </div>
      </div>
      <div className="flex items-center text-sm space-x-6">
        <a
          href="/"
          className="text-gray-700 hover:border-b-2 hover:border-red-500 transition-colors hover:text-gray-900"
        >
          Home
        </a>
        <a
